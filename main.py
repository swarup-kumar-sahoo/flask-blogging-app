...
def register():
    ...
    if (
        ...
        if account:
            ...
            # Fix: Remove extra placeholders to match the actual columns
            cursor.execute(
                'INSERT INTO accounts VALUES (NULL, %s, %s, %s, %s, %s, %s, %s)', 
                (username, password, email, collage, city, state, country)
            )
        ...
        if (
            ...
            if account:
                ...
                cursor.execute(
                    ...
                    (username, password, email, collage, 
                      city, state, country, 
                     session['id'])
                )
                mysql.connection.commit()
